...
parser.add_argument('--rgval', default=1.0, type=float,
                    help='reset bn value')
parser.add_argument('--rgthr', default=0.5, type=float,
                    help='regeneration threshold')
...
print("RG Epoch = {} RG Val = {} RG Thr = {}".format(args.rgepoch,args.rgval,args.rgthr))
